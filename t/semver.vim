...
describe 'composer#semver#parse()'
  ...
  it 'parses the minor version'
    ...
    Expect composer#semver#parse('3').minor is 0
  end

  it 'parses the patch version'
    Expect composer#semver#parse('1.0.1').patch is 1
    Expect composer#semver#parse('2.0').patch is 0
    Expect composer#semver#parse('3').patch is 0
  end
end
...
describe 'composer#semver#compare()'
  ...
  it 'compares with <'
    ...
    Expect composer#semver#compare('10.1.1', '<', '3') is v:false
  end
